---
name: wizard
description: This skill should be used when the user asks to "make a wizard", "write a setup wizard", "walk me through setting up X", "script the manual steps", or needs an interactive bash script that guides a human through steps only they can perform — provisioning infrastructure, creating credentials or CI secrets, clicking through a third-party dashboard, or running a one-off migration or cutover. Not for steps the agent can perform itself.
---
...
Copied from [mattpocock/skills](https://github.com/mattpocock/skills) (`skills/engineering/wizard`), MIT License, Copyright (c) 2026 Matt Pocock. See [LICENSE](LICENSE) in this directory. Only the frontmatter description was changed, to match this plugin's trigger-phrase convention.
